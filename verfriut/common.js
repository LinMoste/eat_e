...
const _0x483607 = process["env"]["HOST"] || "http://172.16.33.7:32768";
...
async function _0x13b336(cookie, _0x2e029b, _0x6e1d25, _0x337126, _0x5e78c0, _0x5868b5 = "") {
    let _0x26dad6 = _0x5a5a78(cookie),
        _0x53800c = _0x26dad6.get("deviceId") || _0x12ee09(44),
        _0x4e4167 = _0x26dad6.get("utdid") || _0x12ee09(24),
        _0x1a4dbb = _0x26dad6.get("unb");
    cookie = removesg(cookie);
    if (!_0x1a4dbb) {
    ...
    let _0x12b30e = _0x26dad6.get("umt"),
        ...
        sign = await _0x57c4d6(_0x4e9cee, _0x57e8e3, _0x3cc622, _0x27bf76, _0x1a4dbb, _0x53800c, _0x4e4167, _0x337126);
    ...
    // }
    // _0x12b30e = sign["x-umt"];
    let header = {
        "x-sgext": encodeURIComponent(sign["x-sgext"]).replace(/%2F/g, '/'),
        "x-sign": encodeURIComponent(sign["x-sign"]).replace(/%2F/g, '/'),
        "x-sid": _0x27bf76,
        "x-uid": _0x1a4dbb,
        "x-pv": "6.3",
        "x-features": "1051",
        "x-mini-wua": encodeURIComponent(sign["x-mini-wua"]).replace(/%2F/g, '/'),
    ...
    let _0x70d05a = "https://acs.m.goofish.com/gw/" + _0x57e8e3 + "/1.0/"
    const params = new URLSearchParams();
    params.append('data', _0x4e9cee);
    params.append('wua', sign["wua"]);

    let body = {"data": _0x4e9cee, "wua": sign["wua"]}
    const _0x3f00c0 = {
        method: "POST",
        url: _0x70d05a,
        headers: header,
    ...
    console.log("\n\n\n===================reqInfoStart===============")
    console.log("url=", _0x70d05a)
    // console.log("headers=", header)
    // console.log("body=", JSON.stringify(body))

    // console.log(_0x3f00c0)

    try {
        const response = await axios.post(_0x70d05a, params, {
            headers: header
        });
...
async function _0x13b336_3(_0x33f7f5, _0x6e1d25, _0x337126, _0x5e78c0 = "", _0x2e029b) {
    ...
    let _0x70d05a = "https://guide-acs.m.taobao.com/gw/" + _0x57e8e3 + "/1.0/"
    const params = new URLSearchParams();
    params.append('data', _0x4e9cee);
    params.append('wua', sign["wua"]);
    params.append('type', 'originaljson');
